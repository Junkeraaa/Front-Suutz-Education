  ...
  const handleCriar = async () => {
    ...
    if(tipo == 'ic' && role == 'professor'){
      try {
        ...
        const response = await fetch('http://srv656114.hstgr.cloud:3000/api/lesson/createLesson', {
          method: 'POST',
          headers: {
      ...
      try {
        const response = await fetch('http://srv656114.hstgr.cloud:3000/api/class/createClass', {
          method: 'POST',
          headers: {
            'Authorization': `Bearer ${token}`,
            'Content-Type': 'application/json',
      ...
      try {
        const response = await fetch('http://srv656114.hstgr.cloud:3000/api/class/insertInClass', {
          method: 'POST',
          headers: {
            'Authorization': `Bearer ${token}`,
            'Content-Type': 'application/json',
