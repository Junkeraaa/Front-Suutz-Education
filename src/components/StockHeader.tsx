...
const StockHeader = ({ index, stockId }) => {
  ...
  useEffect(() => {
    const fetchAcao = async () => {
      try {
        ...
        const response2 = await axios.get(`http://srv656114.hstgr.cloud:4000/wallet/${walletId}/stocks`);
  ...
  useEffect(() => {
    ...
    const fetchStocksByWalletId = async () => {
      try {
        const response = await fetch(`http://srv656114.hstgr.cloud:4000/wallet/${walletId}`, {
          method: 'GET',
          headers: {
  ...
  const handleBuy = async () =>{
    try {
      const response = await fetch(`http://srv656114.hstgr.cloud:4000/stocks/buy/wallet/${walletId}`, {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
        },
  ...
  const handleSell = async () =>{
    try {
      const response = await fetch(`http://srv656114.hstgr.cloud:4000/stocks/sell/wallet/${walletId}`, {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
        },
